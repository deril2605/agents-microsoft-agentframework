r"""Writer -> Reviewer workflow with conditional edges plus workflow state.
...
Run:
    uv run .\scripts\04-ai-driven-workflows\07-wf-conditional-state.py
    uv run .\scripts\04-ai-driven-workflows\07-wf-conditional-state.py --devui
"""
